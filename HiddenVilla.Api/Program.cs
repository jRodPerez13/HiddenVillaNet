...
var mailSettingsSection = builder.Configuration.GetSection("MailJetSettings");
builder.Services.Configure<MailJetSettings>(mailSettingsSection);
...
builder.Services.AddCors(o => o.AddPolicy("HiddenVila", builder =>
{
